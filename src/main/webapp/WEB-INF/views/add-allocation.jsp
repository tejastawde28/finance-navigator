...
<head>
    ...
    <title>Add Allocation - Finance Navigator</title>
        ...
        <main role="main" class="col-md-10 ml-sm-auto px-4 content">
            ...
            <div class="container-fluid py-4">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add New Allocation</h1>
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form:form action="${pageContext.request.contextPath}/allocations/add" method="post" modelAttribute="allocation">
