...
<head>
    ...
    <title>Edit Ledger Entry - Finance Navigator</title>
        ...
        <main role="main" class="col-md-10 ml-sm-auto px-4 content">
            ...
            <div class="container-fluid py-4">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Edit Ledger Entry</h1>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Entry Details</h6>
                            </div>
                            <div class="card-body">

                                <form:form action="${pageContext.request.contextPath}/ledger/edit/${ledgerEntry.id}" method="post" modelAttribute="ledgerEntry">
                                    <form:hidden path="id"/>

                                    <div class="form-group">
                                        <label for="entryDate" class="required-field">Date</label>
                                        <form:input path="entryDate" type="date" class="form-control" id="entryDate" required="required"/>
                                        <form:errors path="entryDate" cssClass="error-message" />
                                    </div>

                                    <div class="form-group">
                                        <label for="description" class="required-field">Description</label>
                                        <form:input path="description" class="form-control" id="description" placeholder="Enter description" required="required"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <form:input path="amount" type="number" step="0.01" min="0.01" class="form-control" id="amount" placeholder="0.00" required="required"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input path="reference" class="form-control" id="reference" placeholder="Invoice #, Receipt #, etc."/>
                                        <form:errors path="reference" cssClass="error-message" />
                                    </div>

                                    <div class="form-group">
                                        <label for="notes">Notes (Optional)</label>
                                        <form:textarea path="notes" class="form-control" id="notes" rows="3" placeholder="Additional notes about this transaction"/>
